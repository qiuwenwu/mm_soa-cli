						...
						<mm_card>
							...
							<div class="card_body">
								...
								<div class="bar_action">
									<h5><span>操作</span></h5>
									<div class="btns">
										<mm_btn class="btn_primary-x" url="./pay_type_form?">添加</mm_btn>
									...
									<tbody>
										...
										<tr v-for="(o, idx) in list_new" :key="idx" :class="{'active': select == idx, sub: o[father_id], open: opens_has(o[field]), no_sub: !opens_has_sub(o[field]) }"
										 @click="selected(idx)">
											...
											<td>
												<mm_btn class="btn_primary" :url="'./pay_type_form?type_id=' + o[field]">修改</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/user/pay_type",
				url_del: "/apis/user/pay_type?method=del&",
				url_set: "/apis/user/pay_type?method=set&",
				url_import: "/apis/user/pay_type?method=import&",
				url_export: "/apis/user/pay_type?method=export&",
				field: "type_id",
				query_set: {
					"type_id": ""
				},
