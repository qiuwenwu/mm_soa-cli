							...
							<div class="card_body">
								<mm_form class="bar_filter">
									...
									<mm_list col="3">
										...
										<mm_item>
											<control_select v-model="query.shop_id" title="所属店铺" :options="$to_kv(list_shop, 'shop_id', 'name')"
											 @change="search()" />
										</mm_item>
										<mm_item>
								...
								<mm_table type="2">
									<thead class="table-sm">
										<tr>
											...
											<th>
												<control_reverse title="所属店铺" v-model="query.orderby" field="shop_id" :func="search"></control_reverse>
											</th>
											<th>
