						...
						<mm_card>
							...
							<div class="card_body">
								<mm_form class="bar_filter">
									...
									<mm_list col="3">
										<mm_item>
											<control_input v-model="query.keyword" title="关键词" desc="分类描述 / 分类名称"
											 @blur="search()" />
										</mm_item>
										<mm_item>
								...
								<div class="bar_action">
									<h5><span>操作</span></h5>
									<div class="btns">
										<mm_btn class="btn_primary-x" url="./product_diy_form">添加</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/mall/product_diy",
				url_del: "/apis/mall/product_diy?method=del&",
				url_set: "/apis/mall/product_diy?method=set&",
				url_import: "/apis/mall/product_diy?method=import&",
				url_export: "/apis/mall/product_diy?method=export&",
				field: "type_id",
				query_set: {
					"type_id": ""
				},
