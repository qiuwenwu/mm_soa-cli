							...
							<div class="card_body">
								<mm_form class="bar_filter">
									...
									<mm_list col="3">
										...
										<mm_item>
											<control_select v-model="query.father_id" title="上级分类" :options="$to_kv(list_shop_type, 'type_id', 'name')"
											 @change="search()" />
										</mm_item>
										<mm_item>
								...
								<div class="bar_action">
									<h5><span>操作</span></h5>
									<div class="btns">
										<mm_btn class="btn_primary-x" url="./shop_type_form?">添加</mm_btn>
			...
			<mm_card class="card">
				...
				<div class="card_body">
					<dl>
						<dt>上级分类</dt>
						<dd>
							<control_select v-model="form.father_id" :options="$to_kv(list_shop_type, 'type_id', 'name')" />
						</dd>
					</dl>
				</div>
				<div class="card_foot">
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/mall/shop_type",
				url_del: "/apis/mall/shop_type?method=del&",
				url_set: "/apis/mall/shop_type?method=set&",
				url_import: "/apis/mall/shop_type?method=import&",
				url_export: "/apis/mall/shop_type?method=export&",
				field: "type_id",
				query_set: {
					"type_id": ""
				},
