						...
						<mm_card>
							...
							<div class="card_body">
								<mm_form class="mm_filter">
									...
									<mm_list col="3">
										<mm_item>
											<mm_input v-model="query.keyword" title="关键词" desc="标题 / 描述 / 关键词 / 标签"
											 @blur="search()" />
										</mm_item>
										<mm_item>
										...
										<mm_item>
											<mm_select v-model="query.type_id" title="店铺分类" :options="$to_kv(list_shop_type, 'type_id', 'name')"
											 @change="search()" />
										</mm_item>
										<mm_item>
											<mm_select v-model="query.channel_id" title="频道" :options="$to_kv(list_shop_channel, 'channel_id', 'name')"
											 @change="search()" />
										</mm_item>
										<mm_item>
										...
										<mm_item>
											<mm_select v-model="query.user_id" title="店铺所属人" :options="$to_kv(list_account, 'user_id', 'nickname')"
											 @change="search()" />
										</mm_item>
										<mm_item>
								...
								<mm_table type="2">
									<thead class="table-sm">
										<tr>
											...
											<th>
												<mm_reverse title="店铺分类" v-model="query.orderby" field="type_id" :func="search"></mm_reverse>
											</th>
											<th>
											...
											<th>
												<mm_reverse title="店铺所属人" v-model="query.orderby" field="user_id" :func="search"></mm_reverse>
											</th>
											<th>
											...
											<th>
												<mm_reverse title="标题" v-model="query.orderby" field="name" :func="search"></mm_reverse>
											</th>
											<th>
