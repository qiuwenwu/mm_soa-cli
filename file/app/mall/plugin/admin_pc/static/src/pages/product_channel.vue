			...
			<mm_card class="card">
				...
				<div class="card_body">
					<dl>
						...
						<dt>上级</dt>
						<dd>
							<control_select v-model="form.father_id" :options="$to_kv(list_product_channel, 'channel_id', 'name')" />
						</dd>
						<dt>所属城市</dt>
						<dd>
	...
	export default {
		...
		data() {
			return {
				...
				url_import: "/apis/mall/product_channel?method=import&",
				url_export: "/apis/mall/product_channel?method=export&",
				field: "channel_id",
				query_set: {
					"channel_id": ""
				},
