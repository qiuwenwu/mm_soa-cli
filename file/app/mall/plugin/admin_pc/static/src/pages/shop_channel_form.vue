							...
							<div class="card_body">
								<mm_form>
									<dl>
										...
										<dt>上级</dt>
										<dd>
											<control_select v-model="form.father_id" :options="$to_kv(list_shop_channel, 'channel_id', 'name', 0)" />
										</dd>
										<dt>所属城市</dt>
										<dd>
										...
										<dd>
											<control_input v-model="form.type" :minlength="0" :maxlength="16" placeholder="question问答 / info资讯 / news新闻 / shop店铺 / activity活动"
											 :required="true" />
										</dd>
										...
										<dt>风格模板</dt>
										<dd>
											<control_input v-model="form.template" :minlength="0" :maxlength="64" placeholder="频道和店铺都使用的样式" />
										</dd>
										<dt>频道图标</dt>
										<dd>
...
<script>
	...
	export default {
		...
		data() {
			return {
				url: "/apis/mall/shop_channel?",
				url_get_obj: "/apis/mall/shop_channel?method=get_obj",
				field: "channel_id",
				query: {
					"channel_id": 0
				},
