							...
							<div class="card_body">
								<mm_form>
									<dl>
										...
										<dt>上级</dt>
										<dd>
											<mm_select v-model="form.father_id" :options="$to_kv(list_shop_channel, 'channel_id', 'name', 0)" />
										</dd>
										<dt>所属城市</dt>
										<dd>
										...
										<dd>
											<mm_input v-model="form.type" :minlength="0" :maxlength="16" placeholder="question问答 / info资讯 / news新闻 / shop店铺 / activity活动"
											 :required="true" />
										</dd>
