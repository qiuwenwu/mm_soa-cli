							...
							<div class="card_body">
								<mm_form class="mm_filter">
									...
									<mm_list col="3">
										...
										<mm_item>
											<mm_select v-model="query.father_id" title="上级" :options="$to_kv(list_shop_channel, 'channel_id', 'name')"
											 @change="search()" />
										</mm_item>
										<mm_item>
			...
			<mm_card class="card">
				...
				<div class="card_body">
					<dl>
						...
						<dt>上级</dt>
						<dd>
							<mm_select v-model="form.father_id" :options="$to_kv(list_shop_channel, 'channel_id', 'name')" />
						</dd>
						<dt>所属城市</dt>
						<dd>
