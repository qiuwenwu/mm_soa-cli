							...
							<div class="card_body">
								<mm_form class="mm_filter">
									...
									<mm_list :col="3">
										...
										<mm_item>
											<mm_select v-model="query.father_id" title="上级分组" :options="$to_kv(list_table_group, 'group_id', 'name')"
											 @change="search()" />
										</mm_item>
										<mm_item>
								...
								<div class="mm_action">
									<h5><span>操作</span></h5>
									<div class="btns">
										<mm_btn class="btn_primary-x" url="./table_group_form?">添加</mm_btn>
								...
								<mm_table type="2">
									...
									<tbody>
										...
										<tr v-for="(o, idx) in list" :key="idx" :class="{'active': select == idx}" @click="selected(idx)">
											...
											<td>
												<span>{{ get_name(list_table_group, o.father_id, 'group_id', 'name') }}</span>
											</td>
											<td>
											...
											<td>
												<mm_btn class="btn_primary" :url="'./table_group_form?group_id=' + o[field]">修改</mm_btn>
			...
			<mm_card class="card">
				...
				<div class="card_body">
					<dl>
						<dt>上级分组</dt>
						<dd>
							<mm_select v-model="form.father_id" :options="$to_kv(list_table_group, 'group_id', 'name')" />
						</dd>
						<dt>适用的应用</dt>
						<dd>
