 ...
 * @param {Object 平台
 */
async function uni_app_home(model) {
	$.log.info("****  开始刷Uni_app客户端前台  ****");
	...
	if (tpl_home) {
		// 模板存放路径
		var _from = "../template/uni_app/home/" + tpl_home + "/tpl/src/";
